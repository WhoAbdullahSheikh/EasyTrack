...
const D_HomeScreen = () => {
  ...
  const busIconColor = mapType === "standard" ? "#fa9837" : "yellow";
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {stops.map((stop, index) => (
          ...
          >
            <Icon name="bus-stop" size={30} color={busIconColor} />
          </Marker>
        ))}
      </MapView>
      ...
      {/* Animated options menu with buttons in a row */}
      {showMapOptions && (
      ...
      <TouchableOpacity
        ...
        onPress={zoomIn}
      >
        <Icon name="plus" size={25} color="#616161" />
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        onPress={zoomOut}
      >
        <Icon name="minus" size={25} color="#616161" />
      </TouchableOpacity>
    </SafeAreaView>
  );
};
